			...
			>
				<div className="content">
					...
					<div className="buttons">
						<LinkButton
							variant="filled"
							to={spotify.getLoginUrl("http://localhost:8000/party/create/", ["playlist-read-private", "streaming", "user-modify-playback-state", "user-top-read"])}
							external={true}>
							Skapa en fest
						</LinkButton>
						...
						<LinkButton
							variant="outlined"
							to={spotify.getLoginUrl("http://localhost:8000/party/join/", ["user-top-read"])}
							external={true}>
							Gå med i fest
						</LinkButton>
					</div>
